...
change.gdp.air.reg <- lm(Growth.Log.GDP~Mean.Annual.Exposure.PM2.5.2013+I(Mean.Annual.Exposure.PM2.5.2013^2), data = df.gdp.air)
...
ggsave("Qn1c.png")
 ...
 gdp.air.reg <- lm(Growth.Log.GDP~Mean.Annual.Exposure.PM2.5.2013, data = df.gdp.air)
